  ...
  <div class="row m-0">
    <div class="col-side" id="FilterSide" style="width: 0;">
      ...
      <div class="ColSide sort">
        ...
        <ul>
          <li><a class="active" data-sort="date" data-name="date" href="javascript:void(0);">date</a></li>
          <li><a data-sort="featured" data-name="featured" href="javascript:void(0);">featured</a></li>
          <li><a data-sort="view" data-name="Popular" href="javascript:void(0);">Popular</a></li>
          <li><a data-sort="date" data-name="Recent" href="javascript:void(0);">Recent</a></li>
          <li><a data-sort="download" data-name="Downloaded" href="javascript:void(0);">Downloaded</a></li>
        </ul>
      </div>
        ...
        <ul>
            @if($taxonomy_query->parent)
              ...
              @endphp
                ...
                <li class="list-item">
                  <a class="text-term active" href="{{ $term_link }}">{{ $taxonomy_query->name }} <span
                ...
                @endphp
                  <li class="list-item">
                    <a class="text-term @if($term->term_id == $taxonomy_query->term_id) active @endif"
                      href="{{ $term_link }}">{{ $term->name }} <span class="count-term">{{ $term->count }}</span></a>
                  </li>
              @endforeach
            @endif
          ...
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col-12 grid-item">
            <div class="card">
              <div class="bg-featureImage featureImage">
                <img src="{{ the_field('images_card_pricing', 'option') }}" class="card-img-top"
                  alt="{{ the_field('heading_card_pricing', 'option') }}">
                <div class="card-overlay"><a class="the_permalink" href="{{ the_field('lik_card_pricing', 'option') }}"></a>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <ul class="meta-buttons">
                  ...
                  <li class="edit-post button-share">
                    <a class="post-edit-link"
                      href="{{ the_field('link_edit_item', 'option') }}?post_id={{ the_ID() }}"><small>Edit</small> <i
                ...
                <div class="card-body pt-2 pl-0 pr-0 pb-0">
                  <a class="card-link" href="{{ the_permalink() }}">
                    <h5 class="card-title font-weight-400">{{ html_entity_decode(wp_trim_words(get_the_title(), '4', ' ...')) }}
                    </h5>
                  </a>
                  <div class="review-and-download">
                    <div class="review">
