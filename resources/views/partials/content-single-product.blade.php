    ...
    @while (have_posts())
        ...
        @if ($more == 'fullScreen')
            <div class="container mt-md-5 relative">
                <div class="row pt-md-5">
                    <a class="BackToSingle" href="{{ $link }}"><i
                    ...
                    @if ($attachment_ids)
                        @foreach ($attachment_ids as $attachment_id)
                            ...
                            <div class="carousel-img">
                                <img src="<?= $large ?>"
                                    class="d-block w-100 lazyload" alt="slide">
                            </div>
                        @endforeach
                    @endif
                </div>
        ...
        @else
            ...
            <div id="product-{{ the_ID() }}" {!! wc_product_class() !!}>
                <div class="container-fluid mt-md-5 mb-5 pt-md-5 product-single">
...
@endif">
                        ...
                        <div
                            class="summary entry-summary col-md-4 col-12 sidebar-shop">
                            ...
                            @if (wp_is_mobile())
                                ...
                                <div class="product-infomation">
                                    ...
                                    <div id="tab-description">{{ the_content() }}
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="media author-media">
                                    @if ($avatar)
                                        <div class="avatar align-self-center mr-3">
                                            <img src="{{ $avatar['url'] }}"
                                                alt="{!! get_the_author_meta('display_name', $author) !!}">
                                        </div>
                                    @else
                                    ...
                                    @if (is_user_logged_in())
                                        ...
                                        @else
                                            <a class="follow"
                                                ...
                                                data-user="<?= $current_user->ID ?>"
                                                data-author="<?= get_the_author_meta('ID') ?>"><span
                                                    class="fo-text">{{ _e('follow', 'premast') }}</span>
                                                <span id="fo-loader"
                                                    style="display:none;"><i
                                                        class="fa fa-spinner fa-spin"
                                                        aria-hidden="true"></i></span></a>
                                        @endif
                                    @else
                                        <a class="login follow" href="#"
                                            data-toggle="modal"
                                            data-target="#LoginUser">Login for
                                            follow</a>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="bottom-download-container">
                        <div class="item-details-container">
                            ...
                            <div class="item-details">
                                ...
                                <p class="text-description">{!! $excerpt !!}
                                </p>
                            </div>
                        </div>
