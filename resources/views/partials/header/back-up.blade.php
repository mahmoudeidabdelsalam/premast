...
@else
    ...
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          @if (has_nav_menu('templates_navigation'))
            {!! wp_nav_menu(['theme_location' => 'templates_navigation', 'container' => false, 'menu_class' => 'navbar-nav mr-auto', 'walker' => new NavWalker()]) !!}
          @endif
        </div>
        @if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) 
        @php 
  ...
  <section class="fixed-top-header bg-light border-top border-secondary">
    <div class="container-fluid">
