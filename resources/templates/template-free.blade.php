    ...
    <div class="container">
      <div class="row align-items-center text-center justify-content-center">
        <div class="col-md-8 col-sm-12 col-12 contentBanner">
          <h1>{{ _e('Best Free PowerPoint Templates Design for your Presentations', 'premast') }}</h1>
          <p>{{ _e('We offer a wide range of free PowerPoint items to our Premast users in every category with different styles and layouts.', 'premast') }}</p>
        </div>
      </div>
    </div>
