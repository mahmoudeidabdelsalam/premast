...
@section('content')
   ...
   @if (get_field('banner_items_headline', 'option'))
      <section class="banner-items mb-5"
               style="background-image: linear-gradient(150deg, {{ the_field('gradient_color_one', 'option') }} 0%, {{ the_field('gradient_color_two', 'option') }} 100%);">
         <div class="elementor-background-overlay"
              style="background-image: url('{{ the_field('banner_background_overlay', 'option') }}');">
         </div>
         <div class="container">
            <div class="row justify-content-center align-items-center text-center">
               <h2 class="col-12 text-white"><strong
                          class="font-weight-600">{{ _e('Discover', 'premast') }}
                     +{{ $count }}</strong> <span
                        class="font-weight-300">{{ the_field('banner_items_headline', 'option') }}</span>
               </h2>
               <p class="col-md-5 col-12 text-white font-weight-300">
                  {{ the_field('banner_items_sub_headline', 'option') }}</p>
            </div>
         </div>
      </section>
   @endif
   <div class="container single-product">
      ...
      @elseif (array_intersect($allowed_roles, $user->roles))
         ...
         <form id="publish_product" name="new_post" method="post" action=""
                     ...
                     <div class="col-12">
                        ...
                        <label for="frontend-button" class="label-upload arrows right">
                           ...
                           <img class="profile-pic"
                                src="{{ get_theme_file_uri() . '/dist/images/upload-image.png' }}">
                        ...
                        <div class="input-group mb-3">
                           <input type="text" class="form-control" name="slide_gallery"
               ...
               <div class="summary entry-summary col-md-4 col-12 sidebar-shop">
                  ...
                  <div class="input-group mb-4 mt-4">
                     <label class="custom-download-label arrows left mb-0" for="upload_file">
                        ...
                        <span
                              class="name-files">{{ _e('upload your download file here', 'premast') }}</span>
                  ...
                  <div class="box-information mt-5">
                     ...
                     <div class="input-group mb-3 slide-info">
                        <input type="text" name="slide_type" class="form-control"
                               placeholder="Compatible with">
                     </div>
                     <div class="input-group mb-3 slide-info">
                        <input type="text" name="slide_format" class="form-control"
                               placeholder="Enter Format of Slides">
                     </div>
                     <div class="input-group mb-3">
                        <input type="text" class="form-control" name="slide_colors"
                  ...
                  <p class="mt-t col-12">
                     <input type="submit" value="publish" tabindex="6" id="submit"
                            name="submit" />
                  </p>
                  <p class="error-field">
