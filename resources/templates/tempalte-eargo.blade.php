...
@section('content')
    ...
    <header class="header-block">
      <div class="container-fluid container-padding">
        <div class="row m-0 align-content-center">
          <a class="logo-template" href="<?= the_field('logo_link_eargo'); ?>"><img src="<?= the_field('logo_image_eargo'); ?>" alt="logo premast"></a>
          ...
          ?>
            <a href="<?=  $link_url; ?>"><img src="{{ the_field('pp_logo') }}" alt="<?=  $link_title; ?>"></a>
            <a class="button-green" target="<?= $link_target; ?>" href="<?=  $link_url; ?>"><?=  $link_title; ?></a>
          <?php endif; ?>
          </div>
        </div>
      </div>
  ...
  <style>
    ...
    header.header-block.fixed-header {
